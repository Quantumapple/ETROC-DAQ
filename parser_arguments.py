...
def create_parser():
    ...
    #------------------------------------------------------------------------#
    parser.add_option("--ws_testing",action="store_true", dest="ws_testing_en", default=False, help="Perform WS Testing rather than usual DAQ")
    ...
    parser.add_option("--start_dev_ws_beam_fc",action="store_true", dest="start_dev_ws_beam_fc", default=False, help="Turn on WS FC")
    parser.add_option("--stop_dev_ws_beam_fc",action="store_true", dest="stop_dev_ws_beam_fc", default=False, help="Turn off WS FC")
