...
def ETROC1_DAC_Config(DAC_Value):
    DAC_160bit = []
    ...
    ETROC1_ArrayReg.set_VTHIn7_0(DAC_8bit[0])
    ETROC1_ArrayReg.set_VTHIn15_8(DAC_8bit[1])
    ETROC1_ArrayReg.set_VTHIn23_16(DAC_8bit[2])
    ETROC1_ArrayReg.set_VTHIn31_24(DAC_8bit[3])
    ETROC1_ArrayReg.set_VTHIn39_32(DAC_8bit[4])
    ETROC1_ArrayReg.set_VTHIn47_40(DAC_8bit[5])
    ETROC1_ArrayReg.set_VTHIn55_48(DAC_8bit[6])
    ETROC1_ArrayReg.set_VTHIn63_56(DAC_8bit[7])
    ETROC1_ArrayReg.set_VTHIn71_64(DAC_8bit[8])
    ETROC1_ArrayReg.set_VTHIn79_72(DAC_8bit[9])
    ETROC1_ArrayReg.set_VTHIn87_80(DAC_8bit[10])
    ETROC1_ArrayReg.set_VTHIn95_88(DAC_8bit[11])
    ETROC1_ArrayReg.set_VTHIn103_96(DAC_8bit[12])
    ETROC1_ArrayReg.set_VTHIn111_104(DAC_8bit[13])
    ETROC1_ArrayReg.set_VTHIn119_112(DAC_8bit[14])
    ETROC1_ArrayReg.set_VTHIn127_120(DAC_8bit[15])
    ETROC1_ArrayReg.set_VTHIn135_128(DAC_8bit[16])
    ETROC1_ArrayReg.set_VTHIn143_136(DAC_8bit[17])
    ETROC1_ArrayReg.set_VTHIn151_144(DAC_8bit[18])
    ETROC1_ArrayReg.set_VTHIn159_152(DAC_8bit[19])
#--------------------------------------------------------------------------#

def config_etroc1(B_num, charge_injection):
    ...
    if(charge_injection):
        ...
        ETROC1_ArrayReg.set_EN_QInj15_8(QInj_Enable[Pixel_Num][1])      # Enable QInj15~8
    else:
        ETROC1_ArrayReg.set_EN_QInj7_0(0x00)       # Disable QInj7~0
        ETROC1_ArrayReg.set_EN_QInj15_8(0x00)      # Disable QInj15~8
    ...
    ETROC1_ArrayReg.set_PhaseAdj(PhaseAdj)     # 0-128 to adjust clock phase
    ######## DOUBLE CHECK NEEDED
    ...
    ETROC1_ArrayReg.set_CLKOutSel(1)           # 0: 40M clock output, 1: 320M clock or strobe output
    ######## DOUBLE CHECK NEEDED
    ...
    ETROC1_ArrayReg.set_TDC_enableMon(Test_Pattern_Mode_Output)       # 0: Connect to TDC       1: Connect to Test Counter
